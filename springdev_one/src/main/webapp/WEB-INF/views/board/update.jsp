...
<tr>
	<th>제목</th>
	<td><input type="text" name="title" value="${vo.title}" style="width:645px;"/></td>
</tr>
<tr>
	<th>내용</th>
	<td><textarea cols="40" rows="5" name="content" id="content" 
	style="width:645px;height:200px;">${vo.content}</textarea>
	<script type="text/javascript">
	var editors = [];
